<form action="${pageContext.request.contextPath}/coordenador_Cadastrar_coordenador">
    <fieldset>
        <legend>Cadastro De Coordenador</legend>
        ...
        <p>
            ...
            <span class="field_desc">Matrícula do Coordenador</span>
        </p>
        <p>
            <label>Nome:</label>
            <input type="text" id="nome" name="nome" class="mf"/>
            <span class="field_desc">Nome do Coordenador</span>
        </p>
        <p>
            <label>CPF:</label>
        ...
        <p>
            ...
            <span class="field_desc">Email do Coordenador</span>
        </p>
        <p>
            <label>Tel. Res:</label>
